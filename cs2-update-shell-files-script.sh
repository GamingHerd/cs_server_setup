...
ENSURE_RUNNING_SCRIPT_URL="https://raw.githubusercontent.com/GamingHerd/cs_server_setup/main/$ENSURE_RUNNING_SCRIPT_FILENAME"
...
wget -O "$ENSURE_RUNNING_SCRIPT_FILENAME" "$ENSURE_RUNNING_SCRIPT_URL"
